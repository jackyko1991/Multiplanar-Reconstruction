...
vtkStandardNewMacro(vtkvmtkCurvedMPRImageFilter2);

template <class T>
void vtkvmtkCurvedMPRImageFilter2::FillSlice(T* outReslicePtr, T* outputImagePtr, int* resliceUpdateExtent, int* outExtent, vtkIdType* outputInc, int slice)
{
	//write result to the new datase
...
int vtkvmtkCurvedMPRImageFilter2::RequestData(
...
void vtkvmtkCurvedMPRImageFilter2::PrintSelf(ostream& os, vtkIndent indent)
{
...
vtkvmtkCurvedMPRImageFilter2::vtkvmtkCurvedMPRImageFilter2()
{
...
//int vtkvmtkCurvedMPRImageFilter2::RequestUpdateExtent(
...
//}
//
//int vtkvmtkCurvedMPRImageFilter2::RequestInformation(vtkInformation * request,
//	vtkInformationVector **inputVector,
//	vtkInformationVector *outputVector)
//{
...
//----------------------------------------------------------------------------
// Compute new extent
int vtkvmtkCurvedMPRImageFilter2::RequestInformation(
	vtkInformation * vtkNotUsed(request),
	vtkInformationVector **inputVector,
	vtkInformationVector *outputVector)
{
